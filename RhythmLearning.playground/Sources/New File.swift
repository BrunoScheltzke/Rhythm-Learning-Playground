...
extension ViewController: DrumItemDelegate {
    public func didPlayDrumItem(_ drumItem: DrumItem) {
        ...
        print("snareView \(snareView.currentProgress)")
        print("hithat \(hitHatView.currentProgress)")
        print("bass \(bassView.currentProgress)")
        
        if snareView.currentProgress >= 1 && hitHatView.currentProgress >= 1 && bassView.currentProgress >= 1 {
            print("UEeeee")
            finishAssessment()
        }
    }
